...
type Pemilu struct {
    ...
    TransactionID string    `gorm:"type:char(36)" json:"transaction_id"` // Mengikat 1 transaksi = 1 acara
    ...
    // TAMBAHAN BARU: Relasi ke tabel Transaction untuk mengambil info paket layanan
